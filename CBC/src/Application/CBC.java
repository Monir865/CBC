...
public class CBC {
    ...
    private CBC(String plainText, String key){
        this.message = plainText;
        this.key = key;
    }

    private String previousCiphertext; // Add a field to store the previous ciphertext block
    ...
    public String encrypt() {
        ...
        if (previousCiphertext != null) {
            String[][] previousCiphertextMatrix = createMatrix(previousCiphertext);
            addRoundKey(messageMatrix, previousCiphertextMatrix);
        }
        ...
        // Store the current ciphertext block for the next iteration
        previousCiphertext = encryptedMessage;
    ...
    public String decrypt() {
        ...
        // Store the current ciphertext block for the next iteration
        previousCiphertext = this.message;
    ...
    public static CBC init(String plainText, String key) throws IllegalArgumentException {
        if(key.length() > 16){
        ...
        return new CBC(plainText, key);
    }

    public static CBC init(String plainText, String key, boolean logging) throws IllegalArgumentException {
        CBC cbc = CBC.init(plainText, key);
        cbc.logging = logging;
        return cbc;
    }
